  ...
  <body>
    <main>
      ...
      <div class="d-flex justify-content-center">
        <form action="" method="post" class="w-50" id="registerForm">
          <div class="py-2">
            <div class="input-group mb-2">
              <div class="input-group-prepend">
                ...
                name="username" placeholder="Friends Name" autocomplete="off"  data-errmsg="Please enter the contact name">
            </div>
          </div>
          ...
          <div class="pt-2">
            <div class="input-group mb-2">
              <div class="input-group-prepend">
                ...
                <input type="text" class="form-control" id="inlineFormInputGroup"
                name="phone" placeholder="Phone Number(233)" autocomplete="off" data-errmsg="Please enter the phone number">
            </div>
          </div>
              ...
              <div class="py-2">
                <div class="input-group mb-2">
                  <div class="input-group-prepend">
                    ...
                    <input type="text" class="form-control" id="inlineFormInputGroup"
                    name="location" placeholder="Place from" autocomplete="off" data-errmsg="Please enter the location">
                </div>
              </div>
              ...
              <div class="py-2">
                <div class="input-group mb-2">
                  <div class="input-group-prepend">
                    ...
                    name="date" placeholder="Date" data-errmsg="Please enter the date">
                </div>
              </div>
          ...
          <div class="d-flex justify-content-center">
           ...
           <button type="submit" id="btnid2" class="btn btn-success mr-3">Create</button>
                  ...
                  <tr>
                    ...
                    <td> <a href="update.php?edit=<?= $row['id']; ?>"
                      ...
                      <a href="process.php?delete=<?= $row['id']; ?>"
                        ...
                        <a href="view.php?view=<?= $row['id']; ?>"
                          class="badge badge-warning p-2">View Record</a> |
